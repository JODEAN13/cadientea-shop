...
global $conn;
$users = $conn->query("SELECT id, first_name, last_name, email, phone, role, created_at FROM users ORDER BY id DESC")->fetch_all(MYSQLI_ASSOC);
$flash = getFlash();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        .user-table tr:hover { background: #fff8fb; }
        ...
        .role-customer { background: #fce8f1; color: #5c3a43; }
        ...
        <div class="table-wrapper">
            <table class="user-table">
                ...
                <tbody>
                    <?php if (empty($users)): ?>
                        <tr>
                            <td colspan="7" style="text-align:center; color:#8a4a60; padding:2rem;">No users yet.</td>
                        </tr>
                    <?php else: ?>
                        <?php foreach ($users as $user): ?>
                            <tr>
                                ...
                                <td style="font-size:0.8rem; color:#8a4a60;"><?= date('M d, Y', strtotime($user['created_at'])) ?></td>
                                <td>
