...
$stmt = $conn->prepare("SELECT id, first_name, last_name, email, phone, address, role FROM users WHERE id = ?");
...
<head>
    ...
    <style>
        ...
        .form-group select:focus { border-color: #ec008c; }
...
<div class="admin-wrapper">
    ...
    <main class="admin-main">
        <div class="admin-header-bar">
            <h1>✏️ Edit User: <?= htmlspecialchars($user['first_name'] . ' ' . $user['last_name']) ?></h1>
            <a href="../index.php" class="view-store-btn">👁 View Store</a>
        </div>
