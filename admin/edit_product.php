...
// If no old data, use existing product data
$old = $old ?: $product;
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        .form-group textarea:focus { border-color: #ec008c; }
        ...
        .alert { padding: 0.85rem 1.1rem; border-radius: 0.75rem; font-size: 0.875rem; margin-bottom: 1.5rem; font-weight: 600; }
            ...
            <form action="update_product.php" method="POST" enctype="multipart/form-data">
                ...
                <?php if ($product['image']): ?>
                    <div class="form-group">
                        ...
                        <img src="../<?= htmlspecialchars($product['image']) ?>" alt="<?= htmlspecialchars($product['name']) ?>" class="current-image" onerror="this.style.display='none'">
                    </div>
                <?php endif; ?>
