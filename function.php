 ...
 */
function createOrder(int $userId, array $cartItems, float $subtotal, float $deliveryFee, float $total, string $paymentMethod, string $orderAddress, string $orderType = 'delivery'): ?int {
    global $conn;
    ...
    ");
    $stmt->bind_param("isddssss", $userId, $orderNumber, $subtotal, $deliveryFee, $total, $paymentMethod, $orderType, $orderAddress);
